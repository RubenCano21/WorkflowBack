...
import {
  ...
  CardComponent,
  CardFooterComponent,
  CardHeaderComponent, CarouselComponent, CarouselControlComponent, CarouselInnerComponent, CarouselItemComponent,
  ColComponent,
...
@Component({
  ...
  imports: [WidgetsDropdownComponent, TextColorDirective, CardComponent, CardBodyComponent, RowComponent, ColComponent,
    ...
    CardHeaderComponent, TableDirective, AvatarComponent, CarouselItemComponent, CarouselInnerComponent, CarouselComponent, NgForOf, CarouselControlComponent, DocsExampleComponent]
})
